    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Manage Stores & Items</a>
            </li>
...
<table>
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM users WHERE deleted = 0;");
				while($row = mysqli_fetch_array($result))
				{
					echo '<tr><td>'.$row["Name_f"].'</td>';
					echo '<td>'.$row["Name_l"].'</td>';
					echo '<td>'.$row["Email"].'</td>';   
          echo '<td><select name="'.$row['U_Id'].'_role">
                      <option value="Administrator"'.($row['Role']=='Administrator' ? 'selected' : '').'>Administrator</option>
                      <option value="Customer"'.($row['Role']=='Customer' ? 'selected' : '').'>Customer</option>
                    </select></td>';
          echo '<td><select name="'.$row['U_Id'].'_memb">
                      <option value="PLatinum"'.($row['Membership_type']=='Platinum' ? 'selected' : '').'>Platinum</option>
                      <option value="Gold"'.($row['Membership_type']=='Gold' ? 'selected' : '').'>Gold</option>
                      <option value="Silver"'.($row['Membership_type']=='Silver' ? 'selected' : '').'>Silver</option>
                      <option value="Normal"'.($row['Membership_type']=='Normal' ? 'selected' : '').'>Normal</option>
                    </select></td>';
          echo "<td>
                <a href='routers/user-delete.php?uid=".$row["U_Id"]."'>delete</a></td></tr>";      					
...
<table>
                    ...
                    <tbody>
				<?php
					echo '<tr><td><label for="email">Email</label><input id="email" name="email" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';   									
					...
					echo '<td><label for="name_f">First Name</label><input id="name_f" name="name_f" type="text" data-error=".errorTxt04"><div class="errorTxt04"></div></td>';
          echo '<td><label for="name_l">Last Name</label><input id="name_l" name="name_l" type="text" data-error=".errorTxt04"><div class="errorTxt04"></div></td>';   
					echo '<td><select name="role">
                      <option value="Administrator">Administrator</option>
                      <option value="Customer" selected>Customer</option>
                    </select></td>';
					echo '<td><select name="memb">
